...
#ifndef C_IR_CONSTANT_INCLUDED
#define C_IR_CONSTANT_INCLUDED
...
class UI8Constant : public Constant
{
public:
    UI8Constant(uint8_t value_);
};
...
class UI16Constant : public Constant
{
public:
    UI16Constant(uint16_t value_);
};
