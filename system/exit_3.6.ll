...
define void @cm_exit()
{
    ...
    %1 = load %destruction$node** @destruction$list
    store %destruction$node* %1, %destruction$node** %node_ptr
    br label %loop

loop:
    %2 = load %destruction$node** %node_ptr
    %3 = icmp ne %destruction$node* %2, null
    br i1 %3, label %next, label %end

next:
    %4 = getelementptr %destruction$node* %2, i32 0, i32 0
    %5 = load %destruction$node** %4
    store %destruction$node* %5, %destruction$node** %node_ptr
    %6 = getelementptr %destruction$node* %2, i32 0, i32 1
    %7 = load i8** %6
    %8 = getelementptr %destruction$node* %2, i32 0, i32 2
    %9 = load void (i8*)** %8
    call void %9(i8* %7)
    br label %loop
...
{
    %1 = load %destruction$node** @destruction$list
    %2 = getelementptr %destruction$node* %node, i32 0, i32 0
