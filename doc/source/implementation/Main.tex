...
the constraints of the function template are satisfied for the bound template argument types,
...
\begin{enumerate}
\item
Let $lc$ be the constraint of the $left$ and $rc$ be the constraint of the $right$.
\item
