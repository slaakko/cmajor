...
A type identifier is a sixteen-byte positive integer that uniquely identifies a type symbol.

\section{Type Identifiers for Basic Type Symbols}
...
\section{Type Identifiers for Class and Interface Type Symbols}
...
\section{Type Identifiers for Class Template Specialization Symbols}

The type identifier for a class template specialization symbol is computed using the following algorithm:

\begin{algo} Computing the Type Identifier for a Class Template Specialization Symbol.
\begin{enumerate}
\item
Let $id$ be the type identifier of the primary class type of the class template specialization.
Let $n$ be the number of type argument symbols of the class template specialization.
\item
For $i$ = 0, \ldots, $n - 1$:
\begin{enumerate}
\item
Let $a$ be the type identifier of type argument $i$ of the class template specialization.
\item
Let $p$ be $(i + 8) \% 16$.
\item
Let $r$ be $a$ rotated $p$ byte positions right.
\item
...
\section{Type Identifiers for Delegate, Class Delegate and Enumerated Type Symbols}
...
\section{Type Identifiers for Derived Type Symbols}
...
\begin{algo} Computing the Type Identifier for a Derived Type Symbol.
\begin{enumerate}
\item
