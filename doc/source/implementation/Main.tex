...
\begin{algo} Resolving a Type. Inputs to this algorithm are:
\begin{itemize}
\item
a type expression represented as an abstract syntax tree node
\item
a container scope and list of file scopes for symbol lookup,
\item
...
\item
\verb|NamespaceSymbol| create a \verb|NamespaceTypeSymbol| that contains the namespace symbol and return it.
\item
