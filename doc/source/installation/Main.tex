...
\title{Getting Started Guide for Cmajor 1.3.0-beta-0}
\author{Seppo Laakko}
\maketitle
...
\item
Download and run \textbf{cmajor-1.3.0-beta-0-win-x86-setup.exe} (for 32-bit Windows) or
\textbf{cmajor-1.3.0-beta-0-win-x64-setup.exe} (for 64-bit Windows).
...
\item
Download and extract \textbf{cmajor-1.3.0-beta-0-tar.gz} or \textbf{cmajor-1.3.0-beta-0.tar.bz2}
