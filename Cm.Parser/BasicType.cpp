...
BasicTypeGrammar::BasicTypeGrammar(Cm::Parsing::ParsingDomain* parsingDomain_): Cm::Parsing::Grammar("BasicTypeGrammar", parsingDomain_->GetNamespaceScope("Cm.Parser"), parsingDomain_)
{
    SetOwner(0);
}

Cm::Ast::Node* BasicTypeGrammar::Parse(const char* start, const char* end, int fileIndex, const std::string& fileName)
{
