...
void FunctionGrammar::GetReferencedGrammars()
{
    ...
    Cm::Parsing::Grammar* grammar0 = pd->GetGrammar("Cm.Parser.ConceptGrammar");
    if (!grammar0)
    {
        grammar0 = Cm::Parser::ConceptGrammar::Create(pd);
    }
    AddGrammarReference(grammar0);
    Cm::Parsing::Grammar* grammar1 = pd->GetGrammar("Cm.Parser.StatementGrammar");
    if (!grammar1)
    {
        grammar1 = Cm::Parser::StatementGrammar::Create(pd);
    }
