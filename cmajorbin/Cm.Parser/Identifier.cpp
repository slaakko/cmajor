...
IdentifierGrammar::IdentifierGrammar(Cm::Parsing::ParsingDomain* parsingDomain_): Cm::Parsing::Grammar("IdentifierGrammar", parsingDomain_->GetNamespaceScope("Cm.Parser"), parsingDomain_)
{
    SetOwner(0);
}
