...
void BindClassDelegate(Cm::Sym::SymbolTable& symbolTable, Cm::Sym::ContainerScope* containerScope,
    const std::vector<std::unique_ptr<Cm::Sym::FileScope>>& fileScopes, Cm::BoundTree::BoundCompileUnit& boundCompileUnit, Cm::Ast::ClassDelegateNode* classDelegateNode, Cm::Sym::ClassDelegateTypeSymbol* classDelegateTypeSymbol);
