...
void StatementGrammar::GetReferencedGrammars()
{
    ...
    Cm::Parsing::Grammar* grammar0 = pd->GetGrammar("Cm.Parsing.Cpp.IdentifierGrammar");
    if (!grammar0)
    {
        grammar0 = Cm::Parsing::Cpp::IdentifierGrammar::Create(pd);
    }
    ...
    Cm::Parsing::Grammar* grammar4 = pd->GetGrammar("Cm.Parsing.Cpp.DeclaratorGrammar");
    if (!grammar4)
    {
        grammar4 = Cm::Parsing::Cpp::DeclaratorGrammar::Create(pd);
    }
