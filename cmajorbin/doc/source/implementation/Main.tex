...
\begin{algo} Evaluating a Constant Expression.
The inputs to this algorithm are:
\begin{itemize}
\item
the constant expression is represented as an abstract syntax tree node.
\item
the target value type, i.e. the type to which the evaluated result is finally converted,
\item
...
\verb|BeginVisit(EnumTypeNode& enumTypeNode)|:
\item
\verb|BeginVisit(DotNode& dotNode)|:
\item
