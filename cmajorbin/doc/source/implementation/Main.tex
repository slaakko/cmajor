...
\item
Chapter 15 discusses templates.
\end{itemize}
\item
...
\item
Clone the return type expression node and the parameter nodes from the $functionTemplateNode$ and set them to $functionInstanceNode$.
\item
