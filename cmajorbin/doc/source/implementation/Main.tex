...
Semantic analysis in Cmajor is done by traversing the abstract syntax tree.
The travelsar algorithms are implemented using variation of the \emph{Visitor} design pattern.
Visitor enables implementation of many algorithms over a class hierarchy
without touching the classes that are part of the class hierarchy.
