...
void PrimaryGrammar::GetReferencedGrammars()
{
    ...
    Cm::Parsing::Grammar* grammar1 = parsingDomain->GetGrammar("Cm.Parsing.Syntax.PrimitiveGrammar");
    if (!grammar1)
    {
        grammar1 = Cm::Parsing::Syntax::PrimitiveGrammar::Create(parsingDomain);
    }
    AddGrammarReference(grammar1);
    Cm::Parsing::Grammar* grammar2 = parsingDomain->GetGrammar("Cm.Parsing.Syntax.CompositeGrammar");
    if (!grammar2)
    {
        grammar2 = Cm::Parsing::Syntax::CompositeGrammar::Create(parsingDomain);
    }
    AddGrammarReference(grammar2);
    Cm::Parsing::Grammar* grammar3 = parsingDomain->GetGrammar("Cm.Parsing.Cpp.StatementGrammar");
    if (!grammar3)
    {
        grammar3 = Cm::Parsing::Cpp::StatementGrammar::Create(parsingDomain);
    }
    AddGrammarReference(grammar3);
    Cm::Parsing::Grammar* grammar4 = parsingDomain->GetGrammar("Cm.Parsing.Syntax.ElementGrammar");
    if (!grammar4)
    {
        grammar4 = Cm::Parsing::Syntax::ElementGrammar::Create(parsingDomain);
    }
