...
#ifndef CM_CORE_DELEGATE_TYPE_OP_REPOSITORY_INCLUDED
#define CM_CORE_DELEGATE_TYPE_OP_REPOSITORY_INCLUDED
#include <Cm.Core/Argument.hpp>
#include <Cm.Sym/ConversionTable.hpp>

namespace Cm { namespace Core {

class DelegateTypeOpRepository
{
public:
    virtual ~DelegateTypeOpRepository();
...
#endif // CM_CORE_DELEGATE_TYPE_OP_REPOSITORY_INCLUDED
