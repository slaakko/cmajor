...
public:
    ...
    Cm::Sym::FunctionSymbol* GetExplicitPointerConversion(Cm::Sym::TypeRepository& typeRepository, Cm::Sym::TypeSymbol* targetType, Cm::Sym::TypeSymbol* sourceType, Cm::Sym::ConversionTable& conversionTable);
...
private:
    ...
    std::unique_ptr<Cm::Sym::FunctionSymbol> explicitPointerConversion;
