...
struct MemVarNameLess
{
    inline bool operator()(const std::pair<Cm::Sym::MemberVariableSymbol*, Ir::Intf::Object*>& left, const std::pair<Cm::Sym::MemberVariableSymbol*, Ir::Intf::Object*>& right) const
    {
