...
#ifndef CM_BIND_FUNCTION_BINDER_INCLUDED
#define CM_BIND_FUNCTION_BINDER_INCLUDED
...
class FunctionBinder: public Cm::Ast::Visitor
{
public:
...
#endif // CM_BIND_FUNCTION_BINDER_INCLUDED
